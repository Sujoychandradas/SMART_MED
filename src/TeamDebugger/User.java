        ...
        regi.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!Pattern.matches(nameRegex, userName)) {
                    ...
                    String queryInsert = "INSERT INTO `UserReg`(`Username`, `FirstName`, `LastName`, `Email`, `Phone`, `Password`, `Age`, `Gender`) VALUES ('"+userName+"','"+firstname+"','"+lastname+"','"+email+"','"+phone+"','"+Pass+"','"+age+"','"+gender+"')";
